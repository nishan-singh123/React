            ...
            <div className="container mx-auto py-3 px-4">
                <div className="flex items-center justify-between ">
                    ...
                    <div className="flex items-center">
                        <button className="text-gray-700 p-1 dark:text-gray-300 hover:text-primary dark:hover:text-primary">
                            <FaMoon />
                        </button>
                        <button className="text-gray-700 p-1 dark:text-gray-300 hover:text-primary dark:hover:text-primary">
                            <FaShoppingCart />
                        ...
                        <button className="block md:hidden text-gray-700 p-1 dark:text-gray-300 dark:hover:text-primary">
                            <FaBars />
                        </button>
                    </div>
                </div>
